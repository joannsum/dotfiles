...
in
{
  ...
  services.home-assistant.config = {
    input_boolean.shannan_jo_not_together = {
    ...
    binary_sensor = [
      {
        platform = "template";
        sensors.different_locations_jo_shannan = {
    ...
    automation = [
        ...
        trigger = [
          {
            ...
            entity_id = "sensor.distance_jo_shannan";
            above = 1;
          }
          {
            platform = "state";
            entity_id = "binary_sensor.different_locations_jo_shannan";
            to = "on";
            for = "00:00:25";
          }
        ];
      ...
      }
      {
        ...
        action = [
          ...
          (notifyjo "Shannan is close to you {{ sensor.distance_jo_shannan | round(2)}}km")
          (notifyShannan "Jörg is close to you {{ sensor.distance_jo_shannan | round(2)}}km")
        ];
      }
    ];
  };
